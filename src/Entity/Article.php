...
class Article
{
     ...
     * @Assert\Length(min=10, minMessage="Votre titre doit vontenir 10 caractères minimum")
     ...
     * @Assert\Length(min=10, minMessage="Votre contenu doit contenir 10 caractères minimum")
     */
    private $content;
